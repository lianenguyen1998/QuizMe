...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void fillQuestionsTable() {
        ...
        add(q1);
        QuizMeModel q2 = new QuizMeModel("Wie viele Zähne hat ein erwachenser Mensch normalerweise?", "26", "30", "32", "36", "Auf jeden Fall über 30", 3);
        add(q2);
        QuizMeModel q3 = new QuizMeModel("Wer wählt den Bundeskanzler?", "Bundeskanzler", "Bundestag", "Bundesrat", "Bundesversammlung", "Es sind mehrere Personen",4);
        add(q3);
        ...
        add(q4);
        QuizMeModel q5 = new QuizMeModel("Welches Land ist kein Mitglied im Sicherheitsrat der Vereinten Nationen?", "USA", "Russland", "Deutschland", "China", "Das Land liegt in Europa", 3);
        add(q5);
        ...
        add(q6);
        QuizMeModel q7 = new QuizMeModel("Wie heißt die Hauptstadt von Thüringen?", "Magdeburg", "Erfurt", "Dresden", "Potsdam", "Die Nachbarstadt ist Weimar", 2);
        add(q7);
        ...
        add(q9);
        QuizMeModel q10 = new QuizMeModel("Wofür steht das L in RTL?", "London", "Luxenbourg", "Liechtenstein", "Los Angeles", "Eine so ähnliche Stadt in Deutschland", 2);
        add(q10);
        ...
        add(q14);
        QuizMeModel q15 = new QuizMeModel("Wie viele Oscars gewann der Film Titanic?", "10", "11", "12", "13", "Mehr als 10", 2);
        add(q15);
        QuizMeModel q16 = new QuizMeModel("Teneriffa, Gran Canaria und Fuerteventura gehören zu den ...?", "kanarischen Inseln", "Balearen", "Karibischen Inseln", "Azoren", "Es sind Inseln", 1);
        add(q16);
        ...
        add(q21);
        QuizMeModel q22 = new QuizMeModel("In welchem Meer liegt die Insel Hawaii?", "Atlantischer Ozean", "Indischer Ozean", "Karibisches Meer", "Pazifischer Ozean", "Einer der Ozeane", 4);
        add(q22);
        ...
        add(q25);
        QuizMeModel q26 = new QuizMeModel("Wie heißt die Schicht der Atmosphäre, die der Erde am nächsten ist?", "Troposphäre", "Stratosphäre", "Mesosphäre", "Thermosphäre", "Das Wort fängt mit 'T' an", 1);
        add(q26);
        ...
        add(q30);
        QuizMeModel q31 = new QuizMeModel("Welche Staatsform hat England?", "Parlamentarische Monarchie", "Konstitutionelle Monarchie", "Absolute Monarchie", "Ständische Monarchie", "keine vollständige Monarchie.", 1);
        add(q31);
        QuizMeModel q32 = new QuizMeModel("Welches ist das höchste Amt in Deutschland?", "Bundespräsident", "Bundeskanzler", "Bundestagspräsident", "Oberster Richter am Bundesverfassungsgericht", "Der Richter sollte neutral sein", 1);
        add(q32);
        ...
        add(q37);
        QuizMeModel q38 = new QuizMeModel("In welchem Land in Europa ist die Geschwindigkeit auf Autobahnen nicht generell begrenzt?", "Schweden", "Deutschland", "Italien", "Frankreich", "QuizMe ist auf deutsch", 2);
        add(q38);
        ...
        add(q39);
        QuizMeModel q40 = new QuizMeModel("Was ist eine veraltete Maßeinheiten für Energie?", "Farbe", "Kalorie", "Exzem", "Kraftstoff", "Farbe ist keine Energie", 2);
        add(q40);
        ...
        add(q41);
        QuizMeModel q42 = new QuizMeModel("Was dient als Nagelschutz statt Hufbeschlag für Huftiere?", "Barhuf", "Knochenschuh", "Hufschuh", "Hufsandale", "Schuhe", 3);
        add(q42);
        ...
        add(q43);
        QuizMeModel q44 = new QuizMeModel("Die übertriebene und ungesunde Beschäftigung mit sich selbst nennt man auch?", "Warzenschau", "Nasenschau", "Leichenschau", "Nabelschau", "Leichenschau führt ein Arzt durch", 4);
        add(q44);
